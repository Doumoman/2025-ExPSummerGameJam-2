...
public class HexAllLines
{
    public List<List<Vector2Int>> GetAllLines()
    {
        ...
        allLines.AddRange(new List<List<Vector2Int>>
        {
            ...
            new List<Vector2Int> { new(6,6), new(5,5), new(4,5), new(3,4), new(2,4), new(1,3), new(0,3) },
            new List<Vector2Int> { new(6,5), new(5,4), new(4,4), new(3,3), new(2,3), new(1,2), new(0,2) },
            new List<Vector2Int> { new(6,4), new(5,3), new(4,3), new(3,2), new(2,2), new(1,1) },
            new List<Vector2Int> { new(6,3), new(5,2), new(4,2), new(3,1), new(2,1) },
            new List<Vector2Int> { new(6,2), new(5,1), new(4,1), new(3,0) },
            new List<Vector2Int> { new(6,1), new(5,0), new(4,0) }
        });
